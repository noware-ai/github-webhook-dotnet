...
{
    [JsonPropertyName("author_association")] public string AuthorAssociation { get; set; } = string.Empty; // e.g. COLLABORATOR
    ...
    [JsonPropertyName("line")] public object? Line { get; set; }
    ...
    [JsonPropertyName("reactions")] public object? Reactions { get; set; }
